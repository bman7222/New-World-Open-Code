...
public class GameManager : MonoBehaviour
{
    ...
    public void addItem(string itemToAdd)
    {
        ...
        //cycle through the item list and if aneempty item or matching item is found add it to the empty slot or already existing item stack
    ...
    public void saveData()
    {
        ...
        //save x pos
        PlayerPrefs.SetFloat("Player_Position_x", PlayerController2.Instance.transform.position.x);

        //save y pos
        PlayerPrefs.SetFloat("Player_Position_y", PlayerController2.Instance.transform.position.y);

        //save z pos
        PlayerPrefs.SetFloat("Player_Position_z", PlayerController2.Instance.transform.position.z);
    ...
    public void loadData()
    {
        ...
        PlayerController2.Instance.areaTransitionName = "";

        //load the saved x,y, and z coordiantes 
        PlayerController2.Instance.transform.position = new Vector3(PlayerPrefs.GetFloat("Player_Position_x"), PlayerPrefs.GetFloat("Player_Position_y"), PlayerPrefs.GetFloat("Player_Position_z"));
