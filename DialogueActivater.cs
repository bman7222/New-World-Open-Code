...
public class DialogueActivater : MonoBehaviour {
	...
	void Update () {
        ...
        if (canActivate && Input.GetButtonDown("Fire1") && !DialogueManager2.Instance.dialogueBox.activeInHierarchy && GameManager.Instance.gameMenuOpen == false && Shop.Instance.shopIsOpen == false && BattleManager.Instance.battleActive==false) 
        {
